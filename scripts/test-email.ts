...
async function testEmail() {
  ...
  const testOrderData = {
    ...
    items: [
      { itemName: 'Butter Chicken', quantity: 2, lineTotal: '$37.98' },
      { itemName: 'Vegetable Samosas', quantity: 1, lineTotal: '$12.99' },
    ],
    subtotal: '$50.97',
    deliveryFee: '$25.00',
    total: '$75.97',
...
Delivery Fee: ${testOrderData.deliveryFee}
TOTAL: ${testOrderData.total}

ORDER NOTES: ${testOrderData.notes}
  ...
  <div style="padding: 20px; background: #f9f9f9;">
    ...
    <table style="width: 100%; border-collapse: collapse;">
      ...
      <tr style="background: #2D5A27; color: white;">
        ...
        <td style="padding: 12px; text-align: right;"><strong>${testOrderData.total}</strong></td>
      </tr>
    </table>

    <p style="background: #fff3cd; padding: 10px; border-radius: 4px; margin-top: 20px;">
      <strong>Note:</strong> ${testOrderData.notes}
    </p>
  </div>
</body>
</html>
